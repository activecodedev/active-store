    ...
    <div class="bg-surface-0 dark:bg-surface-900">
      <div class="flex items-center justify-between flex-col h-screen">
        ...
        >
          ...
          <div class="mb-6">
            ...
            <span class="text-surface-600 dark:text-surface-200 font-medium"
              >Zacznij od uzupełnienia poniższych pól</span
            >
        ...
        <div class="flex flex-wrap items-center pb-20 px-6">
          <span class="text-2xl font-semiboldm-0 mr-8" style="line-height: 22px"
            >active store</span
          >
          <span
            class="m-0 font-medium text-surface-300 dark:text-surface-500"
            style="line-height: 17px"
            >Copyright Ⓒ Active Code</span
          >
        </div>
      </div>
    </div>
        ...
        next: () => {
          ...
          setTimeout(() => {
            this.uiService.showToast(
              Severity.Success,
              'Rejestracja',
              'Pomyślnie utworzono konto użytkownika. Teraz możesz się zalogować danymi, które zostały wrowadzone podczas rejestracji.',
              true,
              'default'
            );
          }, 2000);
