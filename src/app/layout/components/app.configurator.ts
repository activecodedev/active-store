  ...
  template: `
    ...
    >
      <div class="flex flex-col gap-4">
        <div>
          <span class="text-lg font-semibold">Podstawowy kolor</span>
        ...
        <div class="flex flex-col gap-2">
          <span class="text-lg font-semibold">Motyw</span>
          <p-selectbutton
            [ngModel]="darkTheme()"
          ...
          <div class="flex flex-wrap flex-col gap-3">
            <div class="flex">
              <div class="flex items-center gap-2 w-1/2">
                <p-radio-button
                  ...
                  value="static"
                  [(ngModel)]="menuMode"
                  (ngModelChange)="onMenuModeChange('static')"
                  inputId="static"
                ></p-radio-button>
              ...
              <div class="flex items-center gap-2 w-1/2">
                <p-radio-button
                  ...
                  value="overlay"
                  [(ngModel)]="menuMode"
                  (ngModelChange)="onMenuModeChange('overlay')"
                  inputId="overlay"
                ></p-radio-button>
            ...
            <div class="flex">
              <div class="flex items-center gap-2 w-1/2">
                <p-radio-button
                  ...
                  value="slim"
                  [(ngModel)]="menuMode"
                  (ngModelChange)="onMenuModeChange('slim')"
                  inputId="slim"
                ></p-radio-button>
              ...
              <div class="flex items-center gap-2 w-1/2">
                <p-radio-button
                  ...
                  value="slim-plus"
                  [(ngModel)]="menuMode"
                  (ngModelChange)="onMenuModeChange('slim-plus')"
                  inputId="slim-plus"
                ></p-radio-button>
            ...
            <div class="flex">
              <div class="flex items-center gap-2 w-1/2">
                <p-radio-button
                  ...
                  value="reveal"
                  [(ngModel)]="menuMode"
                  (ngModelChange)="onMenuModeChange('reveal')"
                  inputId="reveal"
                ></p-radio-button>
              ...
              <div class="flex items-center gap-2 w-1/2">
                <p-radio-button
                  ...
                  value="drawer"
                  [(ngModel)]="menuMode"
                  (ngModelChange)="onMenuModeChange('drawer')"
                  inputId="drawer"
                ></p-radio-button>
            ...
            <div class="flex items-center gap-2 w-1/2">
              <p-radio-button
                ...
                value="horizontal"
                [(ngModel)]="menuMode"
                (ngModelChange)="onMenuModeChange('horizontal')"
                inputId="horizontal"
              ></p-radio-button>
          ...
          <div class="flex gap-4">
            <div class="flex items-center gap-2">
              <p-radio-button
                ...
                [disabled]="menuMode() === 'horizontal' || darkTheme()"
              ></p-radio-button>
            ...
            <div class="flex items-center gap-2">
              <p-radio-button
                ...
                value="dark"
                [ngModel]="menuTheme()"
                (ngModelChange)="onMenuThemeChange('dark')"
                inputId="dark"
                [disabled]="menuMode() === 'horizontal' || darkTheme()"
              ></p-radio-button>
...
export class AppConfigurator implements OnInit {
  ...
  onMenuModeChange(event: string) {
    this.layoutService.layoutConfig.update((prev) => ({
      ...
      menuMode: event,
      menuTheme:
        event === 'horizontal' && this.darkTheme()
          ? 'dark'
          : event === 'horizontal' && !this.darkTheme()
          ? 'light'
          : this.menuTheme(),
